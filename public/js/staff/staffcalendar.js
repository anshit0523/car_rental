const CONFIG = window.StaffCalendarConfig || window.AdminCalendarConfig || {
    calendarUrl: '/staff/calendar',
    bookingStoreUrl: '/staff/bookings',
    bookingDetailsBaseUrl: '/staff/bookings',
    checkAvailabilityUrl: '/staff/bookings/check-availability-exact',
    searchCustomerUrl: '/staff/bookings/search-customer',
};
...
function openBookingModal(bookingId) {
    ...
    fetch(`${CONFIG.bookingDetailsBaseUrl}/${bookingId}/json`, {
