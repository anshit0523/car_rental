...
@php
    ...
    $bookingsIndexRoute = $isManager
        ? route('manager.bookings.index')
        : route('admin.bookings.index');

    $returnIssueStoreRoute = $isManager
        ? route('manager.return-issues.store', $booking->id)
        : route('admin.return-issues.store', $booking->id);
@endphp
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                <div class="xl:col-span-1 space-y-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-5">
                        ...
                        <p class="text-sm text-blue-800">
                            ...
                            You can update the issue status later from the Damage Reports page.
                        </p>
                    </div>
                </div>
                ...
                <div class="xl:col-span-2">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                        ...
                        <form action="{{ $returnIssueStoreRoute }}"
                              method="POST"
