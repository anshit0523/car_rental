                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($recentBookings as $booking)
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 text-sm text-gray-600">{{ $booking->car->brand->name ?? 'N/A' }}
                                                    {{ $booking->car->model ?? 'N/A' }}</td>
                                                <td class="px-6 py-4 text-sm text-gray-600">{{ $booking->pickup_at->format('M d, Y') ?? 'N/A' }}
                                                </td>
                                                <td class="px-6 py-4 text-sm text-gray-600">{{ $booking->return_at->format('M d, Y') ?? 'N/A' }}
                                                </td>
