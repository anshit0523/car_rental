...
<div id="receiptModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-lg w-full relative">
        <button onclick="closeReceiptModal()" class="absolute top-3 right-3 text-gray-500 hover:text-gray-800 text-xl">✕</button>
    ...
    <div class="bg-white rounded-lg p-6 max-w-md w-full">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Are you sure you want to approve this booking payment?</p>
            </div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
            <p class="text-sm text-green-800">
                Booking: <span id="approveBookingLabel" class="font-semibold"></span>
            </p>
    ...
    <div class="bg-white rounded-lg p-6 max-w-md w-full">
        <div class="flex items-start justify-between mb-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Are you sure you want to reject this booking payment?</p>
            </div>
        ...
        <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
            <p class="text-sm text-red-800">
                Booking: <span id="rejectBookingLabel" class="font-semibold"></span>
            </p>
