...
<div class="max-w-4xl mx-auto p-6">
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <form action="{{ route('staff.return-issues.store', $booking->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('staff.bookings.index') }}" class="px-4 py-2 rounded-lg bg-gray-200 text-gray-800">
                    Cancel
                </a>
