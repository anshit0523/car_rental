...
<div class="h-screen overflow-y-auto bg-gray-50">
    ...
    <a href="{{ route('staff.live-map') }}" class="hover:text-blue-600">Live Map</a>
...
<script>
    ...
    async function loadReplay() {
        ...
        try {
            ...
            const res = await fetch(`{{ route('staff.replay.history') }}?deviceId=${encodeURIComponent(deviceId)}&from=${encodeURIComponent(fromIso)}&to=${encodeURIComponent(toIso)}`, {
