...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-4 md:p-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                @else
                                    <a href="{{ route('staff.calendar', ['date' => $previousWeek]) }}" class="p-2.5 hover:bg-gray-100 rounded-lg transition text-gray-600 hover:text-blue-600">
                                        <i class="fas fa-chevron-left"></i>
                                    </a>
                                @endif
                                ...
                                <a href="{{ route('staff.calendar', ['date' => $nextWeek]) }}" class="p-2.5 hover:bg-gray-100 rounded-lg transition text-gray-600 hover:text-blue-600">
                                    <i class="fas fa-chevron-right"></i>
                                </a>
                                <a href="{{ route('staff.calendar') }}" class="ml-auto px-3 py-2 text-xs font-medium text-blue-600 hover:bg-blue-50 rounded-lg transition">
                                    Today
                                </a>
                            </div>
                        </div>
    ...
    foreach ($car->bookings as $b) {
        ...
        if (in_array($status, ['Confirmed', 'Reserved', 'Pending', 'Active']) &&
...
@endphp
                                       ...
                                       @if($cellBooking && in_array($cellBooking->status->name, ['Confirmed', 'Reserved', 'Pending', 'Active']))
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function buildFilterUrl() {
        ...
        return `{{ route('staff.calendar') }}?${newParams.toString()}`;
    }
...
function openBookingModal(bookingId) {
    ...
    fetch(`/staff/bookings/${bookingId}/json`, {
