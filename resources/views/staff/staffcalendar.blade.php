                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        @else
                                            <a
                                                href="{{ route('staff.calendar', ['date' => $previousWeek, 'view' => request('view', 'weekly'), 'brand_id' => request('brand_id'), 'search' => request('search')]) }}"
                                        ...
                                        <a
                                            href="{{ route('staff.calendar', ['date' => $nextWeek, 'view' => request('view', 'weekly'), 'brand_id' => request('brand_id'), 'search' => request('search')]) }}"
                                            class="p-2.5 hover:bg-gray-100 rounded-lg transition text-gray-600 hover:text-blue-600">
...
window.StaffCalendarConfig = {
    calendarUrl: "{{ route('staff.calendar') }}",
    bookingStoreUrl: "{{ url('/staff/bookings') }}",
    bookingDetailsBaseUrl: "/staff/bookings",
    checkAvailabilityUrl: "{{ url('/staff/bookings/check-availability-exact') }}",
    searchCustomerUrl: "{{ url('/staff/bookings/search-customer') }}",
};
</script>
<script src="{{ asset('js/staff/staffcalendar.js') }}?v={{ time() }}"></script>
@endsection