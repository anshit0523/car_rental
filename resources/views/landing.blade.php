            ...
            <div class="grid md:grid-cols-3 gap-10">
                <div>
                    ...
                    <p class="text-white/70">
                        Dumaguete EZE Car Rental provides clean, reliable, and affordable vehicles for locals and
                        travelers.
                    </p>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-white/70">
                        <li><i class="fas fa-location-dot mr-2 brand-orange"></i>Mangnao Dumaguete City, Philippines
                        </li>
