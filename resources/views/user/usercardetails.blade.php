            ...
            <div class="car-details-grid">
                ...
                <div>
                    <div class="car-panel">
                        ...
                        <div class="relative">
                            <img id="mainCarImage" src="{{ $mainImageUrl }}" alt="{{ $car->model }}" class="car-main-image"
                    ...
                    <div class="booking-card">
                        ...
                        <form action="{{ route('user.booking.create') }}" method="POST" id="bookingForm">
                            ...
                            <div class="booking-grid">
                                <div class="form-group-block">
                                    ...
                                    <input type="text" id="pickup_date" name="pickup_date"
                                        value="{{ request('pickup_date') }}" class="form-input" required autocomplete="off">
                                </div>

                                <div class="form-group-block">
                                    <label class="form-label">Return Date</label>
                                    <input type="text" id="return_date" name="return_date"
                                        value="{{ request('return_date') }}" class="form-input" required autocomplete="off">
                                </div>
                                ...
                                <div class="form-group-block">
                                    ...
                                    <select id="service_type_id" name="service_type_id" class="form-select" required>
                                        <option value="" disabled {{ old('service_type_id') ? '' : 'selected' }}>Select
                                            service</option>
                                ...
                                <div class="form-group-block">
                                    ...
                                    <input type="tel" id="phone" name="phone"
                                        ...
                                        class="form-input" required maxlength="13" inputmode="numeric">
                                ...
                                <div id="locationWrap" class="form-group-block full" style="display:none;">
                                    ...
                                    <input id="service_location" type="text" name="service_location"
                                        value="{{ old('service_location') }}" placeholder="Enter address / landmark"
                                        class="form-input">
                            ...
                            <div class="summary-box">
                                ...
                                <div class="points-box" style="margin-top:14px;">
                                    <h4>Use Points</h4>
                                    <p>
                                        Available Points:
                                        <strong id="available-points">{{ $availablePoints }}</strong>
                                    </p>

                                    <div class="points-row">
                                        <input type="number" name="points_to_use" id="points_to_use" value="0" min="0"
                                            max="{{ $availablePoints }}" class="form-input" placeholder="Enter points">

                                        <button type="button" id="useMaxPointsBtn" class="points-btn">
                                            Use Max
                                        </button>
                                    </div>
                                ...
                                <div class="summary-row discount" style="margin-top:12px;">
                                    <span>Points Discount</span>
                                    <strong id="points-discount">-₱0.00</strong>
                                </div>
                            </div>
                            ...
                            <div class="total-box">
                                ...
                                <p style="margin-top:14px;">Final Total</p>
                                <h4 id="final-total-price" style="color:#16a34a;">₱0.00</h4>
                            </div>
