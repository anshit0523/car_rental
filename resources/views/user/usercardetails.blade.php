                    ...
                    <div class="car-thumbs">
                        @if(count($imageUrls) > 0)
                            @foreach($imageUrls as $index => $imageUrl)
                                <div
                                    class="car-thumb {{ $index === 0 ? 'active' : '' }}"
                ...
                <div class="section-card" id="termsSection">
                    ...
                    <div class="agree-wrap">
                        <label class="agree-label">
                            ...
                            <span>I agree to the <strong>Rental Terms & Conditions</strong>.</span>
                        </label>
                    ...
                    <form action="{{ route('user.booking.create') }}" method="POST" id="bookingForm">
                        ...
                        <div class="summary-box">
                            ...
                            <div class="points-box">
                                ...
                                <p>
                                    Available Points:
                                    <strong id="available-points">{{ number_format($availablePoints) }}</strong>
                                </p>
                                ...
                                <p class="helper-text">10 points = ₱1 discount</p>
                            </div>
                        ...
                        <div class="total-box">
                            ...
                            <h4 id="final-total-price">₱0.00</h4>
                        </div>
