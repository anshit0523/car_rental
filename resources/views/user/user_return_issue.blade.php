...
@section('content')
        ...
        <div class="issue-wrap">
            <div class="issue-card">
                ...
                <div class="issue-body">
                    ...
                    <div class="issue-section">
                        <div class="issue-section-title">Timeline</div>

                        @if($returnIssue->histories->count())
                            <div class="timeline">
                                @foreach($returnIssue->histories->sortByDesc('created_at') as $history)
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-card">
                                            ...
                                            <div class="timeline-meta">
                                                {{ $history->created_at ? $history->created_at->format('M d, Y h:i A') : 'N/A' }}
                        ...
                        @else
                            <div class="timeline-empty">No history updates available yet.</div>
                        @endif
                    </div>

                    <div class="issue-footer">
                        @if($issueStatusName === 'awaiting_payment')
                            <a href="{{ route('user.payments', ['booking_id' => $returnIssue->booking->id, 'return_issue_id' => $returnIssue->id]) }}"
    ...
    <div id="userIssuePhotoModal" class="photo-modal">
        <div class="photo-modal-content">
            ...
            <button type="button" id="userIssuePhotoPrev" class="photo-modal-nav photo-modal-prev"
                onclick="showPreviousUserIssuePhoto()">
                &#8249;
            </button>

            <img id="userIssuePhotoImage" src="" alt="Preview" class="photo-modal-image">

            <button type="button" id="userIssuePhotoNext" class="photo-modal-nav photo-modal-next"
                onclick="showNextUserIssuePhoto()">
                &#8250;
            </button>
