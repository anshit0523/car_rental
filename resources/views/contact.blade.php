...
<!-- Mirrored from z.commonsupport.com/html/carola/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 11 Mar 2026 05:55:49 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="container"> 
            <div class="main_header_inner">
                <div class="main_header_logo">
                    <figure>
                        <a href="index-2.html"><img src="storage/cars/ezelogo.png" alt="Companny Logo"></a>
                    </figure>
                </div>
    ...
    <div class="sticky_header">
        <div class="container">
            <div class="main_header_inner">
                <div class="main_header_logo">
                    <figure>
                        <a href="index-2.html"><a href="index-2.html"><img src="storage/cars/ezelogo.png" alt="Companny Logo"></a>
                    </figure>
                </div>
                <div class="main_header_menu menu_area">
                    <nav class="main-menu">
...
<!-- Breadcrumb Section -->
<section class="breadcrumb-section" style="background-image: url('{{ asset('assets/images/background/inner-banner-bg-4.png') }}');">
    <div class="container">                                  
        <h1>Contact Us</h1>
    </div>
</section>
...
<section class="google-map-section">
    <div class="container">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1980.065606883327!2d-73.87134661653042!3d40.708731123731674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c25e72880ceaf3%3A0x5f9bdf282a54d261!2sThe%20Shops%20at%20Atlas%20Park!5e0!3m2!1sen!2sbd!4v1716089063707!5m2!1sen!2sbd" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
</section>
...
<!-- Main Footer -->
<footer class="main_footer home-three pt_120">
    <div class="container">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                    <div class="footer_widget footer_about_widget">
                        <figure class="footer_widget_logo">
                            <a href="index-2.html"><img src="{{ asset('storage/cars/ezelogo.png') }}" alt="Footer Logo"></a>
                        </figure>                           
        ...
        <div class="footer-bottom-outer">
            <div class="copyright">Copyright &copy; {{ date('Y') }} Dumaguete EZE Car Rental. All Rights Reserved.</div>            
        </div>
    </div>
</footer>
<!-- Main Footer End -->
